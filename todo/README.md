...
2026-09-22 현재 `FND-02`, `AUTH-02~05`의 서버 구현·자동 검증을 완료했다. `FND-01`, `FND-03~05`, `AUTH-01`, `OPS-01`은 부분 완료다. D-01 재학생 제한과 D-04 Redis 세션을 채택했으며, 테스트 52개와 JAR 빌드가 통과했다. 자세한 범위는 [서버 기반 현황](01-foundation.md#구현-현황-2026-09-21)과 [인증 현황](02-auth-users.md#구현-현황-2026-09-22)에 기록했다. 다음은 실제 DataGSM 클라이언트 등록·브라우저 로그인 검증과 `USER-01` 프로필 구현이다. Riot 연동과 서비스 기능은 아직 구현하지 않았다.
